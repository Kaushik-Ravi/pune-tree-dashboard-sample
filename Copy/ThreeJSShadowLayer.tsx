  ...
  useEffect(() => {
    ...
    const customLayer: ThreeJSCustomLayer = {
      ...
      onAdd: function(map: MapLibreMap, gl: WebGL2RenderingContext) {
        ...
        // CRITICAL: Shadow camera must use Mercator units!
        // Objects are in 0-1 coordinate space.
        // Near must be very small. Far covers the depth.
        this.directionalLight.shadow.camera.near = 1e-6;
        this.directionalLight.shadow.camera.far = 2.0;
        
        // Shadow camera frustum (adjust based on viewport)
        // 0.0005 covers approx 2km, suitable for city block shadows
        const d = 0.0005; 
        ...
        // Prevents map bleaching/disappearing
